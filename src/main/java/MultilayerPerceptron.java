...
public class MultilayerPerceptron {
    ...
    List<Double> calculateOutputs(List<Double> inputs) {
        ...
        List<Double> v = getResults(modifiedInputs, hiddenNeurons);
    ...
    /**
     * Teaches MultilayerPerceptron Perception neural network on multiple provided patterns
    ...
    /**
     * Teaches MultilayerPerceptron Perception neural network on single provided pattern
